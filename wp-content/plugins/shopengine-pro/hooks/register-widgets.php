	...
	public function get_list( $list ) {
		...
		$pro_list = [
			...
			'account-wishlist'           => [
				...
				'title'   => esc_html__( 'Account Wishlist', 'shopengine-pro' ),
				'package' => 'pro',
			],
			'categories'               => [
				'slug'    => 'categories',
			...
			'account-form-lost-password'         => [
				...
				'title'   => esc_html__('Reset Password Link Form', 'shopengine-pro'),
				'package' => 'pro',
			],
			'account-form-reset-password'         => [
				'slug'    => 'account-form-reset-password',
				'title'   => esc_html__('Create New Password Form', 'shopengine-pro'),
				'package' => 'pro',
			],
			'checkout-order-pay'         => [
