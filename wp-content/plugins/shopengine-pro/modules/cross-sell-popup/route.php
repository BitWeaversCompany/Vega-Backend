...
class Route extends Api
{
	...
	public function get_cross_sell_products()
	{
		...
		if ($cross_sell_product_ids) {
			// Show only the products that are specifically selected as cross-sell
			// Don't automatically add variations if parent is selected
			$all_product_ids = array_unique($cross_sell_product_ids);
