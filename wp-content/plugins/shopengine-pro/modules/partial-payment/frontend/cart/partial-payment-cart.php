...
class Partial_Payment_Cart {
	...
	public function init() {
		...
		add_filter( 'woocommerce_loop_add_to_cart_link', [ $this, 'add_cart_button_text_change2' ], 30, 3 );
		add_filter( 'woocommerce_product_add_to_cart_text', [ $this, 'add_cart_button_text_change' ], 30, 2 );
	...
	public function add_cart_button_text_change2($link, $product, $args = array()) {
