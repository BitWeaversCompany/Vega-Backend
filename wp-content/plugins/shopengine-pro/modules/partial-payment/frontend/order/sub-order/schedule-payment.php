...
class Schedule_Payment extends WC_Order {
	...
	public function get_user_id( $context = 'view' ) {
		...
		if ( empty($parent) || ! is_a( $parent, 'WC_Order' ) ) {
			return 0;
		}
	...
	/**
	 * Get total. For installment orders, return the sum of fee items
	 * instead of the stored total (which might be wrong).
	 *
	 * @param string $context What the value is for. Valid values are view and edit.
	 * @return float
	 */
	public function get_total( $context = 'view' ) {
		...
		// If no fees found, fall back to parent method
		return $total > 0 ? $total : parent::get_total( $context );
	}
