            ...
            [
                ...
                'fields_options' => [
                    ...
                    'width'  => [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .shopengine-product-size-chart-body .shopengine-product-size-chart-button' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
