...
class ShopEngine_Thankyou_Address_Details extends \ShopEngine\Base\Widget
{
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'shopengine_thankyou_address_details_content_section',
			[
		...
		$this->add_control(
			'shopengine_thankyou_address_details_show_shipping',
			[
				'label' => esc_html__( 'Show Shipping Address', 'shopengine-pro' ),
		...
		$this->add_responsive_control(
			'shopengine_thankyou_address_details_columns',
			[
				'label' => esc_html__( 'Columns', 'shopengine-pro' ),
				'type' => Controls_Manager::SELECT,
				'default' => '1',
				'options' => [
					'1' => esc_html__( '1 Column', 'shopengine-pro' ),
					'2' => esc_html__( '2 Columns', 'shopengine-pro' ),
				],
				'selectors' => [
					'{{WRAPPER}} .woocommerce-customer-details .woocommerce-columns' => 'display: grid; grid-template-columns: repeat({{VALUE}}, minmax(0, 1fr)); gap: 20px;',
					'{{WRAPPER}} .woocommerce-customer-details .woocommerce-columns::before, {{WRAPPER}} .woocommerce-customer-details .woocommerce-columns::after' => 'display: none;',
					'{{WRAPPER}} .woocommerce-column' => 'width: 100% !important; float: none !important;',
				],
				'condition' => [
					'shopengine_thankyou_address_details_show_shipping' => 'yes',
				],
			]
		);
