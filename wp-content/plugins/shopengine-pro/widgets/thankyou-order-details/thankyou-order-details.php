...
class ShopEngine_Thankyou_Order_Details extends \ShopEngine\Base\Widget
{
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'shopengine_thankyou_order_details_content_section',
			[
		...
		$this->add_control(
			'shopengine_thankyou_order_details_show_product_image',
			[
				'label'        => esc_html__('Show Product Image', 'shopengine-pro'),
		...
		$this->add_control(
			'shopengine_thankyou_order_details_product_image_heading',
			[
				'label'     => esc_html__('Product Image', 'shopengine-pro'),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'shopengine_thankyou_order_details_show_product_image' => 'yes',
				],
			]
		);

		$this->add_responsive_control(
			'shopengine_thankyou_order_details_product_image_size',
			[
				...
				'description' => esc_html__('Sets both width and height for the product image.', 'shopengine-pro'),
				'selectors'  => [
					'{{WRAPPER}} .shopengine-order-details-product-image' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; max-width: 250px; max-height: 250px; object-fit: cover; display: inline-block; vertical-align: middle;',
				],
			]
		);

		$this->add_responsive_control(
			'shopengine_thankyou_order_details_product_image_border_radius',
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .shopengine-order-details-product-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
