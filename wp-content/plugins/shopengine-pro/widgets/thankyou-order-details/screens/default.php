...
$show_product_image = isset($settings['shopengine_thankyou_order_details_show_product_image']) && 'yes' === $settings['shopengine_thankyou_order_details_show_product_image'];
        ...
        <div class="shopengine-thankyou-order-details">
            <section class="woocommerce-order-details">
                ...
                <table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
                    ...
                    $order_item_name_filter = null;

                    if($show_product_image) {
                        $order_item_name_filter = function($item_name, $item, $is_visible) {
                            ...
                            $image_html = $product->get_image(
                                ...
                                [
                                    'class' => 'shopengine-order-details-product-image',
                                ]
                            );
                            ...
                            return $image_html . '&nbsp;' . $item_name;
                        };

                        add_filter('woocommerce_order_item_name', $order_item_name_filter, 10, 3);
                    }
                    ...
                    if($order_item_name_filter) {
                        remove_filter('woocommerce_order_item_name', $order_item_name_filter, 10);
                    }
                    ?>
                    </tbody>
