...
class ShopEngine_Product_Filters extends \ShopEngine\Base\Widget
{
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'shopengine_filter_toggle_brand',
			[
				'label'        => esc_html__('Brand Filter', 'shopengine-pro'),
				'type'         => Controls_Manager::POPOVER_TOGGLE,
				'label_off'    => esc_html__('Disabled', 'shopengine-pro'),
				'label_on'     => esc_html__('Enabled', 'shopengine-pro'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'shopengine_filter_brand_title',
			[
				'label'       => esc_html__('Title', 'shopengine-pro'),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__('Brands', 'shopengine-pro'),
				'placeholder' => esc_html__('Type your title here', 'shopengine-pro'),
			]
		);
		...
		//Styles for filter
		$this->add_control(
			'shopengine_filter_brand_styles',
			[
				'label' => esc_html__('Styles', 'shopengine-pro'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'multiple' => true,
		...
		$this->add_control(
			'shopengine_filter_brand_expand_collapse',
			[
				'label' => esc_html__('Expand Collapse by default', 'shopengine-pro'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Show', 'shopengine-pro'),
		...
		$this->add_control(
			'shopengine_filter_brand_hide_empty',
			[
				'label'        => esc_html__('Hide empty brands', 'shopengine-pro'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'shopengine-pro'),
				'label_off'    => esc_html__('No', 'shopengine-pro'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'shopengine_filter_brand_show_count',
			[
				'label'        => esc_html__('Show product count', 'shopengine-pro'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'shopengine-pro'),
				'label_off'    => esc_html__('No', 'shopengine-pro'),
				'return_value' => 'yes',
				'default'      => 'yes',
				'condition' => [
					'shopengine_filter_brand_styles' => 'style_2',
				],
			]
		);

		$this->add_control(
			'shopengine_filter_brand_hierarchical',
			[
				'label'        => esc_html__('Show hierarchy', 'shopengine-pro'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'shopengine-pro'),
				...
				'default'      => 'yes',
				'condition' => [
					'shopengine_filter_brand_styles' => 'default',
				],
			]
		);

		$this->add_control(
			'shopengine_filter_brand_show_parent_only',
			[
				'label'        => esc_html__('Show parent only', 'shopengine-pro'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Yes', 'shopengine-pro'),
				...
				'default'      => '',
				'condition'    => [
					'shopengine_filter_brand_hierarchical!' => 'yes',
				],
			]
		);

		$this->add_control(
			'shopengine_filter_brand_show_image',
			[
				'label'        => esc_html__('Show brand image', 'shopengine-pro'),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__('Show', 'shopengine-pro'),
				'label_off'    => esc_html__('Hide', 'shopengine-pro'),
				'return_value' => 'yes',
		...
		$this->add_control(
			'shopengine_filter_brand_orderby',
			[
				'label'   => esc_html__('Order by', 'shopengine-pro'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'name',
				'options' => [
					'name'  => esc_html__('Brand name', 'shopengine-pro'),
					'order' => esc_html__('Brand order', 'shopengine-pro'),
				],
			]
		);

		$this->add_control(
			'shopengine_filter_except_brand',
			[
				'label' => esc_html__('Except brand', 'shopengine-pro'),
				'label_block' 	=> true,
				'type'			=> ShopEngine_Controls_Manager::AJAXSELECT2,
				'options'		=> 'shopengine_ajaxselect2/product_brand',
				'multiple'		=> true,
				'default'		=> [],
			]
		);
			...
			[
				...
				'conditions' => [
					...
					'terms' => [
						...
						['name' => 'shopengine_filter_brand_styles', 'operator' => '===', 'value' => 'default'],
					],
				],
			...
			[
				...
				'conditions' => [
					...
					'terms' => [
						...
						['name' => 'shopengine_filter_brand_styles', 'operator' => '===', 'value' => 'style_2'],
					],
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-product-filters .shopengine-filter-brands:checked + .shopengine-filter-brand-label' => 'color: {{VALUE}};',
				],
				'conditions' => [
					'relation' => 'or',
					'terms' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-product-filters .shopengine-filter-brand-label .shopengine-style-icon' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-product-filters .shopengine-filter-brand-label:hover .shopengine-style-icon' => 'color: {{VALUE}};transition: all 0.3s ease-in-out;',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .shopengine-product-filters .shopengine-filter-brands:checked + .shopengine-filter-brand-label .shopengine-style-icon' => 'color: {{VALUE}};',
		 ...
		 */
		$this->start_controls_section(
			'shopengine_section_filter_brand_style',
			[
				'label'     => esc_html__('Brand Filter', 'shopengine-pro'),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'shopengine_filter_toggle_brand' => 'yes',
				],
			]
		);

		$this->add_control(
			'shopengine_filter_subbrand_margin',
			[
				'label'      => esc_html__('Sub Brand Padding', 'shopengine-pro'),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => ['px'],
				'default'    => [
					'top'      => '0',
				...
				'selectors'  => [
					'{{WRAPPER}} .shopengine-product-filters .shopengine-filter-brand .shopengine-filter-brand-subbrands' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
					'.rtl {{WRAPPER}} .shopengine-product-filters .shopengine-filter-brand .shopengine-filter-brand-subbrands' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}} !important;',
				],
			]
		);
